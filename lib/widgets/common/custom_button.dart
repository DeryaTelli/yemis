  ...
  Widget build(BuildContext context) {
    ...
    final decoration = isOutlined
        ...
        : BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: shadowColor,
                blurRadius: (gradient == AppColors.volunteerBackgroundGradient)
                    ? 14
                    : 10,
                offset: (gradient == AppColors.volunteerBackgroundGradient)
                    ? const Offset(0, 5)
                    : const Offset(0, 4),
              ),
            ],
    ...
    final defaultTextStyle = isOutlined
        ? (backgroundColor != null
              ? CustomTextStyles.bold16DarkGreyCompact.copyWith(
                  color: backgroundColor,
                )
