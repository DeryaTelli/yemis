...
class AppColors {
  ...
  static const Color unselectedButtonTextColor = Color(
    0xB3000000,
  ); // 0xB3 is approx 70% alpha

  // 6. Ana uygulama geçiş yeri arka plan rengi (Orange Gradient)
  static const LinearGradient mainAppTransitionBackgroundGradient =
      LinearGradient(
        colors: [
          Color(0xFFFEA033), // 17%
          Color(0xFFF7AF5B), // 25%
  ...
  static const Color locationLineColor = Color(
    0xB3EF9F27,
  ); // 0xB3 is approx 70% alpha

  // 9. Yorum yerinin backgroundu ve profil sayfasındaki ayarların yeri (Orange with 30% opacity)
  static const Color commentAndSettingsBackground = Color(
    0x4DD79C1D,
  ); // 0x4D is approx 30% alpha
