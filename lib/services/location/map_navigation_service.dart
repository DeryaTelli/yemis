...
class MapNavigationService {
  ...
  Future<void> openGoogleMaps({
    ...
    if (Platform.isAndroid) {
      ...
      url = 'comgooglemaps://?daddr=$destinationLat,$destinationLng&directionsmode=driving';
    }
    ...
    if (await canLaunchUrl(Uri.parse(url))) {
      ...
      final webUrl = 'https://www.google.com/maps/dir/?api=1&destination=$destinationLat,$destinationLng';
  ...
  Future<void> openYandexMaps({
    ...
    final url = 'yandexnavi://build_route_on_map?lat_to=$destinationLat&lon_to=$destinationLng';
